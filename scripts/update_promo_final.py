...
# 1. Read the newest AVGL text
avgl_path = r'c:\Users\hp\aivideogen\aivideogen\guiones\cyborg001\promo_velo_gravitacional_v3.avgl.txt'
...
project_data['title'] = "PROMO: El Velo Gravitacional (Final Lore)"
...
print(f"Project 131 updated with final lore accuracy. Title: {p.title}")
