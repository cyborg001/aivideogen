...
# 1. Read the newest AVGL text (v6 - 100% Consistent & Real SFX)
avgl_path = r'c:\Users\hp\aivideogen\aivideogen\guiones\cyborg001\promo_velo_gravitacional_v6.avgl.txt'
...
project_data['title'] = "PROMO: El Velo Gravitacional (SFX Reales)"
...
print(f"Project 131 updated with v6 (Real SFX). Title: {p.title}")
