...
# 1. Read the newest AVGL text (v4)
avgl_path = r'c:\Users\hp\aivideogen\aivideogen\guiones\cyborg001\promo_velo_gravitacional_v4.avgl.txt'
...
project_data['title'] = "PROMO: El Velo Gravitacional (Final Lore v4)"
...
print(f"Project 131 updated with lore-accurate script v4. Title: {p.title}")
