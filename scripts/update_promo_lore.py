...
# 1. Read the new AVGL text
avgl_path = r'c:\Users\hp\aivideogen\aivideogen\guiones\cyborg001\promo_velo_gravitacional_v2.avgl.txt'
...
project_data['title'] = "PROMO: El Velo Gravitacional (Lore-Correct)"
...
print(f"Project 131 updated with lore-accurate script. Title: {p.title}")
