...
SECRET_KEY = 'django-insecure-+j!c!i$s1mzw2xtx10z!qf$k8xaafme)_=^zjwln1&=0tg^1&p'
...
# v19.5: Early finish time for audio blocks (avoids abrupt cuts)
AUDIO_EARLY_FINISH = float(os.getenv('AUDIO_EARLY_FINISH', 0.1))
