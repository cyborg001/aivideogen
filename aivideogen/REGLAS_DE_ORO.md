...
## 👤 Identidad y Marca
- **Saludo Oficial**: El saludo inicial en videos y descripciones debe ser siempre: **"¡Hola! Bienvenidos a mi canal"**.
...
2. **Identidad**: El saludo de marca viene inmediatamente después del gancho inicial.
