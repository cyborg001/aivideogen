...
script_path = r'c:\Users\hp\aivideogen\aivideogen\guiones\white_house_japan_summit_2026_fixed.json'
...
project = VideoProject.objects.create(
    title=script_data.get('title', 'Cyborg Video Fixed'),
...
# Trigger Render
print(f"Iniciando renderizado CORREGIDO para {project.title}...")
try:
